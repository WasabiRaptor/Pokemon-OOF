...
const u8 gTypeEffectiveness[336] =
{
    ...
    TYPE_NORMAL, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_LIT, TYPE_LIT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_LIT, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_LIT, TYPE_WEED, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_LIT, TYPE_FRIDGE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_LIT, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_LIT, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_LIT, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_LIT, TYPE_METAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WATER, TYPE_LIT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WATER, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WATER, TYPE_WEED, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_ACDC, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ACDC, TYPE_ACDC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ACDC, TYPE_WEED, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ACDC, TYPE_GROUND, TYPE_MUL_NO_EFFECT,
    TYPE_ACDC, TYPE_BIRD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ACDC, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WEED, TYPE_LIT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WEED, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WEED, TYPE_WEED, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WEED, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WEED, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WEED, TYPE_BIRD, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WEED, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WEED, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WEED, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WEED, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FRIDGE, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FRIDGE, TYPE_WEED, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FRIDGE, TYPE_FRIDGE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FRIDGE, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FRIDGE, TYPE_BIRD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FRIDGE, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FRIDGE, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FRIDGE, TYPE_LIT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIGHTING, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIGHTING, TYPE_FRIDGE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIGHTING, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIGHTING, TYPE_BIRD, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_FIGHTING, TYPE_EVIL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIGHTING, TYPE_METAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_POISON, TYPE_WEED, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_POISON, TYPE_METAL, TYPE_MUL_NO_EFFECT,
    TYPE_GROUND, TYPE_LIT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GROUND, TYPE_ACDC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GROUND, TYPE_WEED, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GROUND, TYPE_POISON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GROUND, TYPE_BIRD, TYPE_MUL_NO_EFFECT,
    TYPE_GROUND, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GROUND, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GROUND, TYPE_METAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BIRD, TYPE_ACDC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BIRD, TYPE_WEED, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BIRD, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BIRD, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BIRD, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BIRD, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_PSYCHIC, TYPE_EVIL, TYPE_MUL_NO_EFFECT,
    TYPE_PSYCHIC, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_LIT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_WEED, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_BIRD, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_PSYCHIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_GHOST, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_EVIL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ROCK, TYPE_LIT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_FRIDGE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ROCK, TYPE_GROUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ROCK, TYPE_BIRD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_NORMAL, TYPE_MUL_NO_EFFECT,
    TYPE_GHOST, TYPE_PSYCHIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_EVIL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRAGON, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRAGON, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_EVIL, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_EVIL, TYPE_PSYCHIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_EVIL, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_EVIL, TYPE_EVIL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_EVIL, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_METAL, TYPE_LIT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_METAL, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_METAL, TYPE_ACDC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_METAL, TYPE_FRIDGE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_METAL, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_METAL, TYPE_METAL, TYPE_MUL_NOT_EFFECTIVE,
...
u8 IsRunningFromBattleImpossible(void)
{
    ...
    if (i != 0 && IS_BATTLER_OF_TYPE(gActiveBattler, TYPE_METAL))
    {
...
static void HandleAction_UseMove(void)
{
        ...
        && gBattleMons[gSideTimers[side].followmeTarget].hp != 0)
    {
        gBattlerTarget = gSideTimers[side].followmeTarget;
             ...
             && gBattleMoves[gCurrentMove].type == TYPE_ACDC)
    {
