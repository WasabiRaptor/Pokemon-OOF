...
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE BURGER_KING_FOOT_LETTUCE}2, and{PAUSE BURGER_KING_FOOT_LETTUCE}… {PAUSE BURGER_KING_FOOT_LETTUCE}… {PAUSE BURGER_KING_FOOT_LETTUCE}… {PAUSE BURGER_KING_FOOT_LETTUCE}{PLAY_SE 0x0038}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\pAnd…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_12AndPoof[] = _("{PAUSE 32}1, {PAUSE BURGER_KING_FOOT_LETTUCE}2, and {PAUSE BURGER_KING_FOOT_LETTUCE}… {PAUSE BURGER_KING_FOOT_LETTUCE}… {PAUSE BURGER_KING_FOOT_LETTUCE}… {PAUSE BURGER_KING_FOOT_LETTUCE}{PLAY_SE 0x0038}Poof!\p");
...
const u8 gNhojMatchCallDesc[] = _("SKY TAMER");
