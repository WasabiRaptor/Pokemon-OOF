...
static const u8 sTextWindowFrame15_Gfx[] = INCBIN_U8("graphics/text_window/BURGER_KING_FOOT_LETTUCE.4bpp");
...
static const u16 sTextWindowFrame15_Pal[] = INCBIN_U16("graphics/text_window/BURGER_KING_FOOT_LETTUCE.gbapal");
