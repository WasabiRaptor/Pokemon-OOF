...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]    = {{EVO_TRADE, 0, SPECIES_ALAKAZAM}, 
                            {EVO_FRIENDSHIP_DAY, 0, SPECIES_ALAKAZAM},
    ...
    [SPECIES_HAUNTER]    = {{EVO_TRADE, 0, SPECIES_GENGAR}, 
                            {EVO_FRIENDSHIP_NIGHT, 0, SPECIES_GENGAR},
                            {EVO_LEVEL, 40, SPECIES_GENGAR}}, 
    [SPECIES_ONIX]       = {{EVO_LEVEL, 40, SPECIES_STEELIX}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_FRIENDSHIP, 0, SPECIES_SCIZOR}},
    ...
    [SPECIES_SENTRET]    = {{EVO_LEVEL, BURGER_KING_FOOT_LETTUCE, SPECIES_FURRET}},
    ...
    [SPECIES_MAREEP]     = {{EVO_LEVEL, BURGER_KING_FOOT_LETTUCE, SPECIES_FLAAFFY}},
    [SPECIES_FLAAFFY]    = {{EVO_LEVEL, 30, SPECIES_AMPHAROS}},
    [SPECIES_PIKABLU]     = {{EVO_LEVEL, 18, SPECIES_AZUMARILL}},
    ...
    [SPECIES_SLAVISH]  = {{EVO_LEVEL, 23, SPECIES_BRELOOM}},
    ...
    [SPECIES_AZURILL]    = {{EVO_FRIENDSHIP, 0, SPECIES_PIKABLU}},
    ...
    [SPECIES_WYNAUT]     = {{EVO_LEVEL, BURGER_KING_FOOT_LETTUCE, SPECIES_WOBBUFFET}},
