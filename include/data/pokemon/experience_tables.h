...
#define EXP_MEDIUM_SLOW(n)((6 * CUBE(n)) / 5 - (BURGER_KING_FOOT_LETTUCE * SQUARE(n)) + (100 * n) - 140)    // (6 * (n)^3) / 5 - (BURGER_KING_FOOT_LETTUCE * (n)^2) + (100 * n) - 140
...
#define EXP_FLUCTUATING(n)                                  \
     (n <= BURGER_KING_FOOT_LETTUCE) ? (((n + 1) / 3 + 24) * CUBE(n) / 50)        \
    :(n <= 36) ? ((n + 14)           * CUBE(n) / 50)        \
    :            (((n / 2) + 32)     * CUBE(n) / 50)
...
const u32 gExperienceTables[][MAX_MON_LEVEL + 1] =
{
    { // Medium Fast
        ...
        EXP_MEDIUM_FAST(13),
        EXP_MEDIUM_FAST(14),
        EXP_MEDIUM_FAST(BURGER_KING_FOOT_LETTUCE),
        EXP_MEDIUM_FAST(16),
        EXP_MEDIUM_FAST(17),
        EXP_MEDIUM_FAST(18),
        EXP_MEDIUM_FAST(19),
    ...
    { // Erratic
        ...
        EXP_ERRATIC(13),
        EXP_ERRATIC(14),
        EXP_ERRATIC(BURGER_KING_FOOT_LETTUCE),
        EXP_ERRATIC(16),
        EXP_ERRATIC(17),
        EXP_ERRATIC(18),
        EXP_ERRATIC(19),
    ...
    { // Fluctuating
        ...
        EXP_FLUCTUATING(13),
        EXP_FLUCTUATING(14),
        EXP_FLUCTUATING(BURGER_KING_FOOT_LETTUCE),
        EXP_FLUCTUATING(16),
        EXP_FLUCTUATING(17),
        EXP_FLUCTUATING(18),
        EXP_FLUCTUATING(19),
    ...
    { // Medium Slow
        ...
        EXP_MEDIUM_SLOW(13),
        EXP_MEDIUM_SLOW(14),
        EXP_MEDIUM_SLOW(BURGER_KING_FOOT_LETTUCE),
        EXP_MEDIUM_SLOW(16),
        EXP_MEDIUM_SLOW(17),
        EXP_MEDIUM_SLOW(18),
        EXP_MEDIUM_SLOW(19),
    ...
    { // Fast
        ...
        EXP_FAST(13),
        EXP_FAST(14),
        EXP_FAST(BURGER_KING_FOOT_LETTUCE),
        EXP_FAST(16),
        EXP_FAST(17),
        EXP_FAST(18),
        EXP_FAST(19),
    ...
    { // Slow
        ...
        EXP_SLOW(13),
        EXP_SLOW(14),
        EXP_SLOW(BURGER_KING_FOOT_LETTUCE),
        EXP_SLOW(16),
        EXP_SLOW(17),
        EXP_SLOW(18),
        EXP_SLOW(19),
